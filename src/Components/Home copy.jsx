    ...
    <>
      ...
      <section>
        <div className="bg-[#DFF0DB] py-8 md:py-12 lg:py-15">
          ...
          <div className="w-full py-6 md:py-10 px-4 md:px-8 lg:px-5">
      ...
      <section>
        <div className="px-4 py-8 md:py-5 lg:py-8 xl:py-15 md:mt-5 lg:mt-8 xl:mt-15">
          ...
          <div className="hidden md:flex flex-col-reverse xl:flex-row px-5  items-start justify-center gap-6 md:gap-18 lg:gap-22 xl:gap-18 2xl:gap-24">
            {/* Left Images */}
            ...
            <div className=" justify-center  w-full xl:w-1/2 2xl:max-w-4xl flex-1">
              <h2 className="text-[28px] md:text-[32px] lg:text-[40px] xl:text-[48px] 2xl:text-[56px] font-semibold font-['Oswald'] text-[#375B2B] mb-3 md:mb-4 lg:mb-5 xl:mb-6">
                About Us
              </h2>
              <p className="text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-semibold leading-snug mb-4 md:mb-5 lg:mb-6 xl:mb-7 2xl:mb-8 text-gray-800">
                At Sree Datta Sai Aqua Solutions, we focus on delivering reliable, science-backed products that support the growth and well-being of fish and prawns. From advanced water care treatments to high-quality feed supplements, our solutions are designed to meet the real needs of aqua farmers across Andhra Pradesh. With a passion for sustainability and farmer success, we aim to make aquaculture more efficient, healthy, and profitable.
              </p>
      ...
      <section className="relative">
        ...
        <div className="relative z-10">
          {/* Header Section */}
          <div className="w-full flex flex-col lg:flex-row text-start lg:text-left justify-center items-start lg:items-center lg:space-x-20 py-10 px-4">
            <div className="text-[28px] font-['Oswald'] text-[#3F573A] font-bold mystyle w-full lg:w-auto">
              Our Core Strengths
            </div>
            <div className="text-[16px] font-['Mulish'] font-semibold w-full lg:w-1/3">
              Expertly formulated solutions for sustainable, successful aquaculture.
            </div>
          </div>

          {/* Card Grid Section */}
          <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:flex px-6 sm:px-8 lg:px-6 xl:px-20 gap-6 lg:gap-3 xl:gap-8 justify-center">
            {[
              {
              ...
              <div
                key={i}
                className={`w-full sm:w-[313px] h-[344px] lg:h-[400px] lg:w-[390px] xl:w-[313px] xl:h-[344px] p-8 py-12 bg-white border border-gray-200 rounded-3xl shadow-sm text-gray-900 group hover:bg-[#6B9362] hover:text-white transition-colors duration-300 text-center ${i % 2 === 1 ? 'sm:mt-20' : ''}`}
              >
                <div className="relative flex items-center justify-center h-[100px] w-[100px] mx-auto">
                  <svg xmlns="http://www.w3.org/2000/svg" width="101" height="100" viewBox="0 0 101 100" fill="none" className="group-hover:stroke-white">
                    <circle
                      cx="50.5"
                      cy="50"
                      r="49"
